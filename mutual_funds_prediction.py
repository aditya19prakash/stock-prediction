    ...
    try:
        ...
        if st.button("Predict") or company_name:
            ...
            if company_name in st.session_state['predictions_cache']:
                ...
                plot_predictions(cached_data['historical_data'], cached_data['combined_predictions'], symbol, company_name, True)
                return
            ...
            with st.spinner("Plotting Graph..."):
                ...
                plot_predictions(stock_data[-120:], combined_predictions, symbol, company_name, True)
    except Exception as e:
        st.error(f"Error: {e}")
